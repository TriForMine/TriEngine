...
namespace {
	...
	using _get_script_creator = triengine::script::detail::script_creator(*)(size_t);
...
EDITOR_INTERFACE
triengine::script::detail::script_creator GetScriptCreator(const char* name)
{
	return (game_code_dll && get_script_creator) ? get_script_creator(triengine::script::detail::string_hash()(name)) : nullptr;
}
