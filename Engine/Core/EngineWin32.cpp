...
bool engine_initialize() {
	if (!triengine::content::load_game()) return false;

	platform::window_init_info info{
		&win_proc, nullptr, L"TriEngine Game" // TODO: Get the game name from the loaded game file
	};
