...
namespace triengine::graphics::d3d12::d3dx {
	constexpr struct {
	...
	{
		constexpr explicit d3d12_descriptor_range(D3D12_DESCRIPTOR_RANGE_TYPE type, u32 descriptor_count, u32 shader_register, u32 space = 0, D3D12_DESCRIPTOR_RANGE_FLAGS flags = D3D12_DESCRIPTOR_RANGE_FLAG_NONE, u32 offset_from_table_start = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND)
			: D3D12_DESCRIPTOR_RANGE1{ type, descriptor_count, shader_register, space, flags, offset_from_table_start }
		{}
	};
	...
	struct d3d12_root_parameter : public D3D12_ROOT_PARAMETER1
	{
		...
		constexpr void as_descriptor_table(D3D12_SHADER_VISIBILITY visibility, const D3D12_DESCRIPTOR_RANGE1* ranges, u32 range_count)
		{
	...
	public:
		...
		d3d12_pipeline_state_subobject& operator=(T subobject) { _subobject = subobject; return *this; }
	private:
